...
import com.osi.loganalyzer.service.LogService;
import com.osi.loganalyzer.service.LogServiceMillsec;
import com.osi.loganalyzer.service.LogServiceMillsecLinux2;
import com.osi.loganalyzer.service.LogServiceMillsecLinux3;
...
public class LogController1 {
	...
	public Map<String, Object> getLogsFromLinux(@RequestBody LogRead logRead) {
		...
		try {
			...
			//comment below line
			//logservice.convertTOMilli(configuration, logRead);
		   ...
		   br = new BufferedReader(new FileReader("E:/Restassured/VenkatSomala/New folder/RestAssuredFramework/TestCases/src/test/resources/returns.log"));
